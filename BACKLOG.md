...
| A10 | **"Geometrizes ⟺ universal ∧ conservative" as an exact proof** on the ansatz catalog (Move E was only directional). | THE_BRIDGE §9 | confirm | M | **RETIRED (ill-posed)** (2026-06-24): "geometrizes" is a tabula-side legibility property, not a metric theorem; "exact proof on the ansatz catalog" does not map to a well-posed computation. Move E already covers the directional claim. Dropped rather than faked. |
...
| ⊘ | **A10 geometrizes-proof** | **RETIRED — ill-posed** (not a metric theorem; Move E covers the directional claim) | — |
