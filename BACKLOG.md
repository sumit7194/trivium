...
**Family status:** four sisters (ansatz · tabula · deepstrain · quantum), **three** new legs this round
(S, T, U), 21 legs + 8 moves total. Open frontier unchanged: MN deep sea x<1.5 (higher-precision
integrator, parked).
