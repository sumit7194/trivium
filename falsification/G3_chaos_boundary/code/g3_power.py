...
EDGES = {"1.3": [5.1704, 12.35225], "1.5": [6.00008, 14.16437]}
HALF, STEP = 0.08, 0.0005   # 0.001 gave only ~160 bankable orbits/delta, not ~320
OUT = Path(__file__).resolve().parent.parent / "results" / "g3_power.json"
