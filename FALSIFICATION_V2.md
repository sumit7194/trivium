...
6. ~~**S2**~~ **✓ DONE 2026-07-24 — SURVIVES** (curved-space rung: rest-buzz reads √(n(n+2)) to 0.42%, degeneracy (n+1)² measured via the n≥ℓ cutoff; n=3/m²=15 producible by no unit flat T³). The instrument is a method, not a flat-space artifact. [falsification/S2_s3_tower](falsification/S2_s3_tower) → **S3** the drum compactification (next)

**Round-10 standing (2026-07-24):** all of Tier R fired (R1 KILLED · R2 CROSS-GATE+O4 · R3 KILLED · R4 TRUE ·
R5 KILLED-as-stated · R6 KILLED), Tier A fired (A1 SURVIVES), Tier S half fired (S1 KILLED · S2 SURVIVES ·
S3 open), G8 SURVIVES. **Ledger so far: 6 kills, 3 survivals, 1 postulate-true, 1 cross-gate + 1 new
obstruction (O4) — and 6 self-caught instrument bugs, every one a silent failure that looked like a result.**
